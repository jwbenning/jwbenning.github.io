...
**Light theme, stated explicitly.** Your terminal is probably dark; that is your environment,
not a spec for the files you produce. Left unstated, the agent infers a theme and gets it wrong half the time.
