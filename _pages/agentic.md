...
<div class="wk-note">
  <span class="lbl">who wrote this</span>
  <p>These pages were drafted by Claude, working from my own configuration files, project
  folders and notes, and lightly edited by me. That is not incidental to the subject: the setup
  described here is what let an agent write an accurate account of it, and a page claiming
  otherwise would be a poor advertisement for the method. Where a page reports a measurement,
  a failure or a decision, it is mine and it happened. Errors are mine too — please
  <a href="#corrections">tell me</a> about them.</p>
</div>
