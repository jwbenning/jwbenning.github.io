...
The Fall 2026 application window has closed. **We will be recruiting a PhD student to start Fall 2027.**
...
Read more about Cornell's application process [here](https://ecologyandevolution.cornell.edu/graduate). You can compare stipends across similar graduate programs with [this great resource](https://mlgaynor.com/BiologyPhDStipends/) created by Michelle L. Gaynor and Rhett M. Rautsaw.

## Undergraduate students

Cornell undergraduates interested in research with the lab should contact [John](mailto:jbenning@cornell.edu) directly. Please include a short note on your background, what you'd like to work on, and your year/major.
