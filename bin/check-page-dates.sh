...
DEPS=(
  ...
  "_pages/agentic_start.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
  "_pages/agentic_norms.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
  "_pages/agentic_context.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
  "_pages/agentic_hooks.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
  "_pages/agentic_terminal.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
  "_pages/agentic_skills.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
  "_pages/agentic_tools.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
  "_pages/agentic_assistant.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
  "_pages/agentic_reports.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
  "_pages/agentic_machines.md|_includes/agentic_wiki.liquid _data/agentic_wiki.yml"
